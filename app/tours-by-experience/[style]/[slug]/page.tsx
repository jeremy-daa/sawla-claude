          ...
          <div className="container-max text-ivory">
            <AnimateIn>
              ...
              <div className="flex flex-wrap gap-2.5 mt-6">
                ...
                {itin?.priceFrom && <span className="border border-gold/55 text-gold rounded-full px-4 py-1.5 font-body font-medium" style={{ fontSize: "12.5px" }}>{itin.priceFrom}</span>}
                    ...
                    {itin.days.map((day, i) => (
                      <details key={i} className="border border-sand rounded-card overflow-hidden group" open={i === 0}>
                        <summary className="flex items-center gap-4 px-5 py-4 cursor-pointer list-none hover:bg-gold-faint/40 transition-colors">
                          <span className="font-display text-gold font-light flex-shrink-0" style={{ fontSize: "1.125rem", minWidth: "3.5rem" }}>Day {day.day}</span>
              ...
              {suitability && (
                <AnimateIn>
                  ...
                  <p className="mt-4 text-warmgrey font-body" style={{ fontSize: "12.5px" }}>
                    Not sure?{" "}
                    <Link href="/enquire" className="text-gold hover:underline">Ask our specialists — no commitment required.</Link>
                  </p>
                </AnimateIn>
              )}
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      {linkedDestinations.map(d => (
                        <Link key={d.slug} href={"/ethiopias-popular-destinations/" + d.slug}
                          className="group flex items-center gap-4 p-4 rounded-card border border-sand bg-white hover:border-gold/40 hover:bg-gold-faint/30 transition-all duration-300">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="font-display text-volcanic font-normal group-hover:text-gold transition-colors leading-snug" style={{ fontSize: "1rem" }}>{d.name}</div>
                            <div className="text-warmgrey font-body mt-0.5" style={{ fontSize: "11.5px" }}>{d.region}</div>
                            <div className="text-gold/60 font-body mt-0.5" style={{ fontSize: "11px" }}>{d.difficulty} · {d.idealStay}</div>
                          </div>
                          <span className="text-gold/40 group-hover:text-gold group-hover:translate-x-0.5 transition-all flex-shrink-0">{ARROW}</span>
                        </Link>
                      ))}
                    </div>
                    <p className="mt-4">
                      <Link href="/ethiopias-popular-destinations" className="inline-flex items-center gap-1.5 text-gold hover:text-volcanic transition-colors font-body font-medium" style={{ fontSize: "12px", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                        All 18 Ethiopia Destinations {ARROW}
                      </Link>
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn>
                  <div className="p-7 bg-volcanic rounded-card text-ivory">
                    <div className="grid sm:grid-cols-2 gap-6 items-center">
                      <div>
                        <h3 className="font-display text-ivory font-light mb-3" style={{ fontSize: "clamp(1.25rem,2vw,1.625rem)" }}>What&apos;s Included?</h3>
                        <p className="text-ivory/65 font-body leading-relaxed" style={{ fontSize: "0.9375rem" }}>
                          Every Sawla Tours journey is private and tailor-made — exact inclusions are confirmed with your personalised quote within 24 hours.
                        </p>
                      </div>
                      <div className="flex flex-col gap-3">
                        <Link href="/enquire" className="btn-gold justify-center">Request Full Inclusions &amp; Quote</Link>
            ...
            <aside className="lg:col-span-1">
              <div className="sidebar-sticky space-y-5">
                ...
                <div className="bg-volcanic rounded-card p-7 text-ivory">
                  ...
                  {itin?.priceFrom && (
                    <div className="font-display text-gold font-light mb-1" style={{ fontSize: "clamp(1.375rem,2.25vw,1.875rem)" }}>{itin.priceFrom}</div>
                  )}
                  ...
                  <Link href="/enquire" className="btn-gold w-full justify-center mb-3">Enquire About This Tour</Link>
                  <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 py-2.5 border border-white/20 rounded-sm text-ivory/70 hover:border-[#25D366] hover:text-[#25D366] transition-colors font-body cursor-pointer"
                    style={{ fontSize: "12px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                    {WA_ICON} WhatsApp
                ...
                {tourStyle && (
                  <div className="border border-gold/20 rounded-card p-5 bg-gold-faint/40">
                    ...
                    <Link href={"/tours-by-experience/" + style} className="inline-flex items-center gap-1.5 text-gold hover:text-volcanic transition-colors font-body font-medium" style={{ fontSize: "11.5px", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                    ...
                    <div className="space-y-2">
                      {linkedGuides.map(g => (
                        <Link key={g.slug} href={"/ethiopia-travel-guide/" + g.slug}
                          ...
                          <span className="text-gold/40 group-hover:text-gold transition-colors flex-shrink-0 ml-2">{ARROW}</span>
                        </Link>
                      ))}
                    </div>
                    <Link href="/ethiopia-travel-guide" className="inline-flex items-center gap-1 mt-4 text-gold hover:text-volcanic transition-colors font-body font-medium" style={{ fontSize: "11px", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                      All Guides {ARROW}
                    </Link>
                  </div>
                )}
        ...
        <section className="bg-gold-faint/40 py-16 border-t border-sand/60">
          <div className="container-max max-w-3xl mx-auto text-center">
            <AnimateIn>
              ...
              <Link href="/testimonials" className="inline-flex items-center gap-1.5 mt-6 text-gold hover:text-volcanic transition-colors font-body font-medium" style={{ fontSize: "12px", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                ...
                <div key={r.slug}>
                  <Link href={"/tours-by-experience/" + style + "/" + r.slug}
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-display text-volcanic font-normal leading-snug group-hover:text-gold transition-colors mb-2" style={{ fontSize: "clamp(1rem,1.5vw,1.1875rem)" }}>{r.name}</h3>
                      {r.priceFrom && <div className="text-gold font-body font-medium" style={{ fontSize: "12.5px" }}>{r.priceFrom}</div>}
                    </div>
                  </Link>
                </div>
              ))}
            ...
            <AnimateStagger className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4" staggerDelay={0.07}>
              {linkedMoments.map(a => (
                <Link key={a.slug} href={"/sawla-moments/" + a.slug}
                  ...
                  <div className="p-5">
                    <div className="text-gold/70 font-body mb-2" style={{ fontSize: "10px", letterSpacing: "0.12em", textTransform: "uppercase" }}>{a.category}</div>
              ...
              <div className="flex flex-wrap gap-2">
                {linkedGuides.map(g => (
                  <Link key={g.slug} href={"/ethiopia-travel-guide/" + g.slug}
                    ...
                    {g.title}
                    <span className="text-gold/50">{ARROW}</span>
                  </Link>
                ))}
              </div>
            </AnimateIn>
