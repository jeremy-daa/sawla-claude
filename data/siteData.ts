...
export const NAV_LINKS = [
  ...
  },
  {
    ...
    children: [
      { label: 'Heritage Pilgrimage', href: '/tours-by-experience/historic-and-cultural-tours' },
      { label: 'Tribal Encounters', href: '/tours-by-experience/tribal-cultural-ethiopia-tours' },
      { label: 'Wildlife & Birding', href: '/tours-by-experience/ethiopia-wildlife-tours' },
      { label: 'Frontier Adventure', href: '/tours-by-experience/ethiopia-adventure-tours' },
      { label: 'Festival Immersion', href: '/tours-by-experience/ethiopia-festival-tours' },
      { label: 'Photography & Cinematic', href: '/tours-by-experience/ethiopia-photography-tours' },
      { label: 'All 36 Itineraries →', href: '/tours-by-experience' },
    ],
  },
...
export const DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    region: 'Amhara Region',
    tagline: 'The last stronghold of the Ethiopian wolf. UNESCO World Heritage escarpment.',
    ...
    excerpt: 'The Simien Mountains National Park is a UNESCO World Heritage Site and one of Ethiopia\'s most dramatic landscapes. Home to gelada monkeys, Walia ibex, and the rare Ethiopian wolf, the escarpment drops nearly 1,500 metres in places.',
    highlights: ['Gelada monkey encounters at Chenek camp', 'Walia ibex in rocky northern sections', 'Lammergeier vultures on escarpment thermals', 'Multi-day trekking routes', 'Sunrise from Chenek escarpment edge'],
    bestTime: 'October to February',
  ...
  },
  {
    ...
    region: 'Afar Region',
    tagline: 'One of the hottest places on earth. Surreal, unmissable, unforgettable.',
    ...
    excerpt: 'The Danakil Depression sits at 116 metres below sea level and reaches temperatures of 50°C in summer. Home to Erta Ale\'s active lava lake, Dallol\'s sulphur springs, and vast salt flats traversed by camel caravans.',
    highlights: ['Erta Ale active lava lake', 'Dallol sulphur and acid springs', 'Salt flat camel caravans', 'Afar community encounters', 'Alien-landscape photography'],
  ...
  },
  {
    ...
    tagline: '88 communities, living traditions, authentic access.',
    ...
    excerpt: 'The Omo Valley in southern Ethiopia is home to some of Africa\'s most culturally distinct communities — Hamar, Karo, Mursi, Daasanach, and Banna among them. Visiting requires care, patience, and a guide who understands the social protocols.',
    highlights: ['Hamar bull-jumping ceremony', 'Karo cliff art and body painting', 'Mursi community visits', 'Daasanach near Lake Turkana', 'Dimeka market days'],
  ...
  },
  {
    ...
    excerpt: 'The Bale Mountains National Park encompasses the Sanetti Plateau — Africa\'s largest Afroalpine ecosystem — and the Harenna forest. It is the primary habitat of the Ethiopian wolf and home to mountain nyala, Bale monkey, and over 300 bird species.',
  ...
  },
  {
    ...
    tagline: 'The fourth holiest city in Islam. Ancient walled city, hyenas, and Rimbaud.',
    ...
    excerpt: 'Harar Jugol — the walled inner city — is a UNESCO World Heritage Site and one of the most intact medieval Islamic cities in the world. The city has 82 mosques, over 100 shrines, a labyrinthine market, and one of the most unusual wildlife traditions in Africa: the nightly hyena feeding.',
    highlights: ['Hyena feeding at dusk — a 400-year tradition', 'Harar Jugol walled old city (UNESCO)', '82 mosques and over 100 shrines', 'Arthur Rimbaud\'s house museum', 'Colorful spice and khat market', 'Ge\'ez language and unique Harari culture'],
    bestTime: 'October to March',
    duration: '2–3 days',
    difficulty: 'Easy',
    featured: false,
    metaTitle: 'Harar Ethiopia Tours | Walled City & Hyenas | Sawla Tours',
    metaDescription: 'Explore Harar with Sawla Tours — the UNESCO walled city, hyena feeding tradition, 82 mosques, Rimbaud\'s house, and one of Ethiopia\'s most atmospheric markets. Private guided tours.',
  ...
  },
  {
    ...
    tagline: 'The birthplace of coffee. Cloud forest, biodiversity, and the origin of a drink that changed the world.',
    ...
    excerpt: 'The Kafa Biosphere Reserve in south-western Ethiopia is widely regarded as the birthplace of coffee — the forest where Coffea arabica grows wild and where the drink was first discovered. A UNESCO Biosphere Reserve, it protects one of the last remaining stretches of Afromontane cloud forest in Africa and is home to the highest concentration of wild coffee gene diversity on earth.',
    highlights: ['Wild coffee forest — the origin of Coffea arabica', 'UNESCO Biosphere Reserve', 'Kafa traditional coffee ceremonies', 'Bonga market — coffee and culture', 'Endemic birds and forest wildlife', 'Waterfall walks through the coffee forest'],
    bestTime: 'October to January',
    duration: '2–3 days',
    difficulty: 'Easy',
    featured: false,
...
export const TOUR_STYLES: TourStyle[] = [
  ...
  },
  {
    ...
    description: 'Ethiopia has 31 endemic mammal species and over 20 endemic birds. The Ethiopian wolf, gelada monkey, Walia ibex, and Stresemann\'s bushcrow exist nowhere else. These journeys are designed for travelers who understand that rarity is more valuable than abundance.',
  ...
  },
  {
    ...
    description: 'Ethiopia\'s extremes — the lowest point in Africa, the highest peaks of the Simien, the remotest roads of the south — require preparation, logistics, and a team that has been there before. These journeys go where others don\'t.',
  ...
  },
  {
    ...
    description: 'Ethiopia\'s Orthodox calendar shapes the year. Timkat in January, Meskel in September, Enkutatash in October — each a massive, deeply meaningful celebration that turns towns and mountains into seas of white and colour.',
